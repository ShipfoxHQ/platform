...
CREATE INDEX "integrations_connection_repository_grants_connection_owner_name_idx" ON "integrations_connection_repository_grants" USING btree ("connection_id",lower("repository_owner"),lower("repository_name"));--> statement-breakpoint
