...
CREATE INDEX "workflows_tool_invocations_due_at_unsettled_idx" ON "workflows_tool_invocations" USING btree ("due_at") WHERE "workflows_tool_invocations"."status" <> 'settled';