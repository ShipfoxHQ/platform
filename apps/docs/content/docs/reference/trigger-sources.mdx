...
| GitHub | integration connection slug, for example `github_acme` | `push` and other repository events | [Connect GitHub](/integrations/github/setup) |
| Sentry | integration connection slug, for example `sentry_acme` | `issue.created`, `issue.resolved`, `issue.assigned`, `issue.archived`, `issue.unresolved` | [Connect Sentry](/integrations/sentry/setup) |
