...
const glossaryHeadings = [
  'Agent session in Shipfox',
  'Agent step in Shipfox',
  'CEL expressions in Shipfox',
  'Job execution in Shipfox',
  'Feedback loop in Shipfox',
  'Event filter in Shipfox',
  'Gate in Shipfox',
  'Agent harness in Shipfox',
  'Job in Shipfox',
  'Step key in Shipfox',
  'Listening job in Shipfox',
  'AI model in Shipfox',
  'Pipeline terminology in Shipfox',
  'Project in Shipfox',
  'Model provider in Shipfox',
  'Step and job outputs in Shipfox',
  'Run in Shipfox',
  'Runner in Shipfox',
  'Run step in Shipfox',
  'Secret in Shipfox',
  'Workflow step in Shipfox',
  'Thinking level in Shipfox',
  'Workflow trigger in Shipfox',
  'Variable in Shipfox',
  'Workflow in Shipfox',
  'Workspace in Shipfox',
];
