...
export const storybooks = [
  ...
  {
    id: 'client-agent-access',
    title: 'Client Agent Access',
    package: '@shipfox/client-agent-access',
    order: 2,
    source: 'libs/client/agent-access/storybook-static',
    path: '/client-agent-access/',
    url: '/client-agent-access/index.html',
  },
  {
    id: 'client-agent',
    title: 'Client Agent',
  ...
  },
  {
    ...
    package: '@shipfox/client-onboarding',
    order: 7,
    source: 'libs/client/onboarding/storybook-static',
    path: '/client-onboarding/',
    url: '/client-onboarding/index.html',
  },
  {
    id: 'client-projects',
