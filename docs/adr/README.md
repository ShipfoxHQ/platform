...
| [0008: Administration capabilities](0008-administration-capabilities.md) | Accepted | Administrator roles, capabilities, module ownership, audit semantics, and suspension behavior. |
