...
| Adds or changes an administrator role, administration capability, administration route, audit contract, or suspension behavior. | [ADR 0008](adr/0008-administration-capabilities.md) | Auth authorization ownership, module-owned administration, dashboard access, audit semantics, and suspension behavior. |
