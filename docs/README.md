...
| Adds or changes the impersonation capability, an impersonated-session contract, or impersonation authorization rules. | [ADR 0014](adr/0014-admin-user-impersonation.md) | The access-token-only session model, renewal semantics, authorization and anti-escalation rules, and capability placement. |
